...
export const SURAHS: Surah[] = [
  ...
  { number: 46, name: "الأحقاف", englishName: "Al-Ahqaaf", englishNameTranslation: "The Wind-Curved Sandhills", numberOfAyahs: 35, revelationType: "Meccan" },
  ...
  { number: 51, name: "الذاريات", englishName: "Adh-Dhaariyaat", englishNameTranslation: "The Winnowing Winds", numberOfAyahs: 60, revelationType: "Meccan" },
  ...
  { number: 66, name: "التحريم", englishName: "At-Tahrim", englishNameTranslation: "The Prohibtiion", numberOfAyahs: 12, revelationType: "Medinan" },
